...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li>
            <?= $this->Html->link(__('New Signup'), ['action' => 'add']) ?>
        </li>
        <li>
        ...
        <li>
            <?= $this->Html->link(__('List Assignments'), ['controller' => 'Assignments', 'action' => 'index']) ?>
        </li>
        <li>
            <?= $this->Html->link(__('New Assignment'), ['controller' => 'Assignments', 'action' => 'add']) ?>
        </li>
    </ul>
</nav>
<div class="signups index large-9 medium-8 columns content">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <?= $this->Number->format($signup->id) ?>
                </td>
                <td>
                    <?= $signup->has('show') ? $this->Html->link($signup->show->id, ['controller' => 'Shows', 'action' => 'view', $signup->show->id]) : '' ?>
                </td>
                <td>
                    <?= $signup->user_id ?>
                </td>
