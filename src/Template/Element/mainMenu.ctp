 <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
     <ul class="nav navbar-nav navbar-center fa-ul" style="margin-left:20px">
        ...
        <li><?= $this->Html->link(__('  Sign Ups'), ['controller' => 'months', 'action' => 'index','plugin'=>false], ['class'=>'fas fa-pen-alt menuIcon', 'title'=>'View Shows']);?></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li class="disabled"><?= $this->Html->link(__('Dashboard'), ['controller' => 'ClubStandings', 'action' => 'index','plugin'=>false]);?></li>
            <li class="disabled"><?= $this->Html->link(__('Table Manager'), ['controller' => 'dropdowns', 'action' => 'index','plugin'=>false]);?></li>
            <li class="disabled"><?= $this->Html->link(__('Club Standings'), ['controller' => 'dropdowns', 'action' => 'index','plugin'=>false]);?></li>
            <li role="separator" class="divider"></li>
            <li><?= $this->Html->link(__('Shows'), ['controller' => 'shows', 'action' => 'manager','plugin'=>false]);?></li>
            <li class="disabled"><?= $this->Html->link(__('Practice'), ['controller' => 'practices', 'action' => 'manager','plugin'=>false]);?></li>
            <li class="disabled"><?= $this->Html->link(__('Check ins'), ['controller' => 'checkins', 'action' => 'index','plugin'=>false]);?></li>
            <li style="font-weight:bold; color:green"><?= $this->Html->link(__('Members'), ['controller' => 'users', 'action' => 'members','plugin'=>'Usermgmt'],['class'=>'text-success']);?></li>
            <li class="disabled"><?= $this->Html->link(__('Membership'), ['controller' => 'UserDetails', 'action' => 'index','plugin'=>false]);?></li>
          </ul>
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
