    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <div class="navbar-header navbar-center" style="margin-left:50px">
                ...
                <a class="navbar-brand" " href="/"><?= $this->Html->image('CWXRedBrand.png', ['alt' => 'CWX Brand', 'class' => 'brandImg']); ?>Membership
                    Portal</a> </div> <?php echo $this->element('mainMenu'); ?> </nav> <div class="jumbotron">
                    <div class="container">
            ...
            <div id="footer" style="background-color:#fff !important;">
                <div class="container" style="background-color:#fff">
                    <p class="muted" style="background-color:#fff">Copyright &copy; <?php echo date('Y'); ?> CWX
                        Membership Portal. All Rights Reserved. Developed By <a href="http://www.lovettcreations.org/"
