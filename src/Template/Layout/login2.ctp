...
<head>
    ...
    <title><?php echo $this->fetch('title');?>  | Lovett Creation Softwares</title>
...
<body>
    ...
    <div class="footer">
            <p class="muted">xxxCopyright &copy; <?php echo date('Y', strtotime('-1 year'))." - ".date('Y', strtotime('+2 year'));?> North Carolina Association of Colleges and Employers. All Rights Reserved. <a href="http://lovettcreations.org/" target='_blank'>Developed By Lovett Creations</a>.</p>
    </div>
