...
<head>
    ...
    <title>
        <?php echo $this->fetch('title'); ?> CWX Membership Portal | Lovett Creations</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <div class="navbar-header navbar-center" style="margin-left:50px">
                ...
                <a class="navbar-brand" " href="/"> <?=$this->Html->image('CWXRedBrand.png', ['alt' => 'CWX Brand',
                    'class' => 'brandImg']); ?>ComedyWorx Membership Portal</a>
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="http://comedyworx.com">Comedyworx.com</a></li>
                    <li><a href="http://members.comedyworx.com">CWX Portal</a></li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        </div>
    ...
    <div id="footer">
        <div class="container">
            <p class="muted">Copyright &copy;
                <?php echo date('Y'); ?> CWX Membership Portal. All Rights Reserved. Developed By <a href="http://www.lovettcreations.org/"
                    target='_blank'>Lovett Creations</a>.</p>
        </div>
    </div>
</body>
