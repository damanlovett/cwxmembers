        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header navbar-center" style="margin-left:50px">
                ...
                <a class="navbar-brand" " href="/"><?= $this->Html->image('CWXRedBrand.png', ['alt' => 'CWX Brand', 'class' => 'brandImg']); ?>Membership
                    Portal</a> </div> <?php echo $this->element('mainMenu'); ?> </nav> <div class="header"></div>
            <?= $this->Flash->render() ?>
            ...
            <div id="footer">
                <div class="container">
                    <p class="muted">Copyright &copy; <?php echo date('Y'); ?> CWX Membership d Portal. All Rights
                        Reserved. Developed By <a href="http://www.lovettcreations.org/" target='_blank'>Lovett
                            Creations</a>.</p>
                </div>
            </div>
</body>
