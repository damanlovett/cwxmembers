...
<div class="months index large-12 medium-11 columns content">
    <h3><i class="fas fa-pen-alt fa-l fa-fw"></i>&nbsp;&nbsp;<?= __('Sign Ups') ?>&nbsp;&nbsp;<small style="color:white;margin-right:20px;">[ by month ]</small>
...
<?php endforeach; ?>
        ...
        <thead>
            <tr>
                ...
                <th scope="col"style="text-align:center;"><i class="fas fa-calendar fa-l fa-fw"></i>&nbsp;<?= __('Shows') ?></th>
                <th scope="col"style="text-align:center;"><i class="fas fa-pen-alt fa-l fa-fw"></i>&nbsp;<?= __('Sign Ups') ?></th>
                <th scope="col"style="text-align:center;"><i class="fas fa-chalkboard-teacher fa-l fa-fw"></i>&nbsp;<?= __('Practices') ?></th>
            </tr>
        </thead>
        <tbody>
