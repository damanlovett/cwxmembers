...
<div class="months index large-12 medium-11 columns content">
    <h3><i class="fas fa-pen-alt fa-l fa-fw"></i>&nbsp;&nbsp;<?= __('Sign Ups') ?>&nbsp;&nbsp;<small style="color:white;margin-right:20px;">[ by show ]</small>
...
<?php endforeach; ?>
    ...
    <table class="table table-striped" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                <td>                    <?= $this->Html->link(__(''), ['action' => 'view', $show->id], ['class'=>'fas fa-eye fa-l fa-fw text-success', 'title'=>'View Show']) ?>
</td>
                <td>                    <?= $this->Html->link(__(''), ['controller'=>'months','action' => 'view', $show->month_id], ['class'=>'far fa-eye fa-l fa-fw text-success', 'title'=>'View Month']) ?>
</td>
                <td>                <?php if($show->signups_open == 1) : ?>
                ...
                <td>
                <?php if($show->signups_open == 1) : ?> <?= $this->Form->create(null, [
                ...
                <td>                    <a href="http://www.cmx.com" title="Show URL"><i class="fab fa-chrome fa-l text-success fa-fw"></i></a>
</td>
<td>&nbsp;</td>
                ...
                <td style="text-align: center;"><?= $show->numberOfSignups() ? $show->numberOfSignups() : '0' ?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
            <tfoot>
                <td colspan="10"><?php if (empty($show)): ?><p class="text-md-center">Currently, there are no available shows</p><?php endif; ?>&nbsp;
