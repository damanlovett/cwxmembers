...
<div class="shows view large-12 medium-11 columns content">
    <h3>
        ...
        <div class="btn-toolbar pull-right" role="toolbar" aria-label="...">
            <?= $this->Html->link(__("Back to Sign Ups"), ['controller' => 'Months', 'action' => 'mobile', $show->month_id], ['class' => 'btn btn-sm', 'title' => 'Back to Sign Ups']) ?>
    ...
    <div class="fpageTitle">
		...
		?>
            <?= $this->Form->button(__('<i class="fas fa-pen-alt fa-1x fa-fw text"></i> &nbsp;  Sign Up'), ['class' => 'btn btn-success']) ?>
            <?= $this->Form->end() ?>
            <?php else : ?>
            ...
            <div class="panel-heading" role="tab" id="headingOne">
                <h2 class="panel-title">
                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne"
                        ...
                        <span class="glyphicon glyphicon-triangle-bottom" style="padding-right: 10px"></span>Show
                        Information
                    </a>
                </h2>
            </div>
        ...
        <table class="table table-striped" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    ...
                    <?= $this->Form->postLink(__(''), ['controller' => 'signups', 'action' => 'remove', $signups->id], ['class' => 'fas fa-minus-square fa-lg fa-fw text-dander', 'title' => 'Delete Signup']) ?>
