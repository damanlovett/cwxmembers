...
<div class="practices view large-12 medium-11 columns content">
    <h3><i class="fas fa-calendar fa-1x fa-fw"></i><?= h($practice->title) ?><div class="btn-group btn-group-sm pull-right" role="group" aria-label="...">
...
<?php if ($practice->open == 1) {
    ...
    echo "<div class='alert alert-danger' role='alert'> Check-in enable.  Please contact the instructor if you need to check in to practice</div>";
