													...
													<div class="modal-content">
														<div class="row">
															<div class="col-md-12" style="padding:30px;">
																...
																<p>As you all know by now, we had a visit from the ALE (awww) a few weeks ago and we need to make sure that
																	anyone who works selling alcohol at our concession has their ABC Certification. If you have not yet been
																...
																<ul>
																	...
																	<li>Click on the “Search for a business that I represent that currently holds permits OR has applied for permits”
																		radio button</li>
																	...
																	<li>When you are done, you’ll be able to download a PDF copy of the ABC Certificate. Please e-mail your certification
													...
													<div class="modal-content">
														<div class="row">
															<div class="col-md-12" style="padding:30px;">
																...
																<p>In order to be eligible to practice, play or support any of our shows you will need to have signed off on
																	the ComedyWorx Shortform Guide Attestation Form. It requires that you have read and agree to the policies
																	in Shortform Guide and Harassment Policy. </p>
																<div class="list-group">
																	<span class="list-group-item active">
																		Important Documents
																	</span>
																	<span class="list-group-item">Shortform Attestation Form - [
																		<a href="https://goo.gl/ZMLffs" target="_blank">https://goo.gl/ZMLffs</a> ]</span>
																	<span class="list-group-item">Shortform Guide: [
																		<a href="https://goo.gl/WAH1E6" target="_blank">https://goo.gl/WAH1E6</a> ]</span>
																	<span class="list-group-item">Harassment Policy: [
																		<a href="https://goo.gl/Lt1VeW" target="_blank">https://goo.gl/Lt1VeW</a> ]</span>
																</div>
															</div>
														</div>
														<div class="modal-footer">
					...
					<div class="users view large-12 medium-11">
						<table class="table table-striped table-bordered" cellpadding="0" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									<td>
										<?php if(!empty($assignment->Dropdowns['name'])) { echo $assignment->Dropdowns['name'] ;} ?>
									</td>
									<td>
										<?php if(!empty($assignment->show->schedule)) { echo $this->Switches->dateTime($assignment->show->schedule) ;} ?>
									</td>
									<td>
					...
					<div class="users view large-12 medium-11 ">
						<table class="table table-striped table-bordered" cellpadding="0" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									<td>
										<?php if(!empty($checkin->practice->title)) { echo $checkin->practice->title ;} ?>
									</td>
									<td>
										<?php if(!empty($checkin->practice->schedule)) { echo $this->Switches->dateTime($checkin->practice->schedule) ;} ?>
									</td>
									<td>
										<?php if(!empty($checkin->practice->leader)) { echo "<i class='fas fa-chalkboard-teacher fa-l fa-fw'></i> &nbsp;&nbsp;".$checkin->practice->leader ;} ?>
									</td>
								</tr>
								<?php endforeach; ?>
							</tbody>
					...
					<div class="users view large-12 medium-11">
						<table class="table table-striped table-bordered" cellpadding="0" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									<td>
										<?php if(!empty($signup->Dropdowns['name'])) { echo $signup->Dropdowns['name'] ;} ?>
									</td>
									<td>
										<?php if(!empty($signup->show->schedule)) { echo $this->Switches->dateTime($signup->show->schedule) ;} ?>
									</td>
								</tr>
								<?php endforeach; ?>
							</tbody>
