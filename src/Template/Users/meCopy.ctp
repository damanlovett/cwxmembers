...
<div class="users view large-12 medium-11 columns content">
    <h3 class="pageTitle"><i class="fas fa-user fa-2x fa-fw"></i>&nbsp;&nbsp;<?= 'My Activities' ?></h3>
    ...
    <table class="table vertical-table table-striped" cellpadding="0" cellspacing="0">
<!-- able class="vertical-table"> -->
        <tr>
